...
?>
    ...
    <form action="TreinoForm.php" method="post">
        ...
        <input type="radio" name="objetivo_peso" id="perder_peso" value="perder_peso" <?php echo !empty($treino->objetivo_peso) && $treino->objetivo_peso == 'perder_peso' ? 'checked' : ''; ?>> 
        <label for="perder_peso">Perder Peso</label>

        <input type="radio" name="objetivo_peso" id="ganhar_peso" value="ganhar_peso" <?php echo !empty($treino->objetivo_peso) && $treino->objetivo_peso == 'ganhar_peso' ? 'checked' : ''; ?>>
        <label for="ganhar_peso">Ganhar Peso</label>
