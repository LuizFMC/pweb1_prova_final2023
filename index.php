...
No primeiro slide podemos observar pessoas que não praticam nenhum tipo de atividade física e tem péssimos hábitos alimentares.
  ...
  <div class="side-t ic-l decor col-bg-1 p-2"><span class="fa fa-dumbbell"></span>&nbsp;Produtos Growth</div>
  <nav class="side-r col-bg-1 align-items-start">
    <a href="https://www.gsuplementos.com.br/creatina/">
      <i class="fas fa-angle-right"></i> Creatina <i class="fas fa-star"></i>
    </a>
    <a href="https://www.gsuplementos.com.br/busca/?busca=Whey">
      <i class="fas fa-angle-right"></i> Whey <i class="fas fa-star"></i>
    </a>
    <a href="https://www.gsuplementos.com.br/busca/?busca=Pr%C3%A9+Treino">
      <i class="fas fa-angle-right"></i> Pré-Treino <i class="fas fa-star"></i>
    </a>
    <a href="https://www.gsuplementos.com.br/barra-de-proteina/">
      <i class="fas fa-angle-right"></i> Barrinhas <i class="fas fa-star"></i>
    </a>
    <a href="https://www.gsuplementos.com.br/hipercaloricos/">
      <i class="fas fa-angle-right"></i> Hipercalóricos <i class="fas fa-star"></i>
    </a>
    <a href="https://www.gsuplementos.com.br/oleo-de-peixe//">
      <i class="fas fa-angle-right"></i> Óleo de peixe <i class="fas fa-star"></i>
    </a>
    <a href="https://www.gsuplementos.com.br/albumina/">
      <i class="fas fa-angle-right"></i> Albumina <i class="fas fa-star"></i>
    </a>
    <a href="https://www.gsuplementos.com.br/melatonina/">
      <i class="fas fa-angle-right"></i> Melatonina <i class="fas fa-star"></i>
    </a>
    <a href="https://www.gsuplementos.com.br/hipercaloricos/">
      <i class="fas fa-angle-right"></i> Cafeínas <i class="fas fa-star"></i>
    </a>
  </nav>
</aside>
   </div>
